...
{
    /**
     * Get the API endpoint for the class.
     */
    public static abstract function getBaseUrl(): ?string;

    public static abstract function getInstanceUrl(string $id): ?string;

    /**
     * Refreshes a record from the API.
     *
     * @return object
     */
    public function refresh()
    {
        ...
        $response = $request->get(
            static::getInstanceUrl($this->id)
        );

        $this->setCache($response->json());
